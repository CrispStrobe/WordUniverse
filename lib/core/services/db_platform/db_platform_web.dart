...
Future<Database> initPlatformDatabase({
  ...
  try {
    ...
    try {
      ...
      debugPrint("[DB_WEB] Decompressed to ${decompressedSizeMB} MB in ${stopwatch.elapsedMilliseconds}ms");
    ...
    debugPrint("[DB_WEB] Total initialization time: ${stopwatch.elapsedMilliseconds}ms");
