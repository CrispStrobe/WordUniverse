...
# --- Configuration ---
DEFAULT_DB_FILENAME = "en_wiktionary_normalized_full.db"
DEFAULT_SOURCE_REPO_ID = "cstr/en-wiktionary-extracted"
DEFAULT_TARGET_REPO_ID = "cstr/en-wiktionary-sqlite-full"
BATCH_SIZE = 5000
...
This schema includes all tables from the standard `en-wiktionary-sqlite-normalized` dataset, plus the following additions:
...
*(For the standard schema, see the `cstr/en-wiktionary-sqlite-normalized` dataset card)*
...
def main():
    ...
    parser.add_argument(
        '--skip_download',
        action='store_true',
        help="Skip downloading, use existing 'en-wiktionary.jsonl' in current dir"
    )
    parser.add_argument(
        '--skip_upload',
        action='store_true',
    ...
    if args.upload_only:
        ...
        jsonl_path = 'en-wiktionary.jsonl'
