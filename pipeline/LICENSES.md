...
|---|---|---|---|
| `100Fehler.csv`, `300Fehler.csv`, `400Fehler.txt` | Dr. Gero Tacke (Schulpsychologe, Heidelberg), based on Wolfgang Menzel's 1985 empirical study (2000 student essays) | Freely distributed by German schools as PDF for educational use; Tacke retains authorship. **No formal commercial license.** Our build only pulls the headwords (not Tacke's example sentences). | step 01 commonLearnerErrors seed |
